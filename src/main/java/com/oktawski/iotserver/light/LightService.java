...
// import com.oktawski.iotserver.superclasses.DeviceServiceImpl;
// import com.oktawski.iotserver.superclasses.IDeviceService;
...
// @Service
// public class LightService extends DeviceServiceImpl<Light> implements IDeviceService<Light> {
...
//         if (lightByMac == null) {
//             return new BasicResponse<>(null, "Cannot add existing light");
//         }
...
//         return new BasicResponse<>(lightByMac, "Light added");
//     }
